...
class UserBlocksTest {
    ...
    void testWithEqualEmails() {
        ...
        assertEquals("Jack jack@yahoo.com",
                resultList.get(0).getName()
                        + " " + resultList.get(0).getEmail());
        assertEquals("Ieromenko Oksi oksi_23@ukr.net",
                resultList.get(1).getName()
                        + " " + resultList.get(1).getEmail());
        assertEquals("Oleksiy Olegovitch Masaltsev a.o.masaltsev@gmail.com",
                resultList.get(2).getName()
                        + " " + resultList.get(2).getEmail());
    }
}
