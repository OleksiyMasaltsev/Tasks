/**he fusc function is defined recursively as follows:

 1. fusc(0) = 0
 2. fusc(1) = 1
 3. fusc(2 * n) = fusc(n)
 4. fusc(2 * n + 1) = fusc(n) + fusc(n + 1)
 The 4 rules above are sufficient to determine the value of fusc for any non-negative input n. For example,
 let's say you want to compute fusc(10).
...
public class FuscOne {
    public static int fusc(int n) {

        System.out.println("fusc() invoked");
